        ...
        <div className=' justify-center items-center flex w-full h-[961px] font-bold font-serif bg-[url("/deniz2.jpg")] bg-no-repeat bg-cover'>
            <div className='w-8/12 h-[661px] backdrop-blur-xl text-black flex'>
                ...
                <div className='w-7/12 flex justify-center items-center'>
                    <form className='w-6/12 flex flex-col text-green-950 space-y-6' action="/" method="post">
                        <label className='flex flex-col' for="first">First name:
                        <input className='outline-none bg-transparent p-2 border-2 border-solid border-green-950' type="text" id="first" name="first" /></label>
                        <label className='flex flex-col' for="last">Last name:
                        <input className='outline-none bg-transparent p-2 border-2 border-solid border-green-950' type="text" id="last" name="last" /></label>
                        <label className='flex flex-col' for="last">Mail:
                        <input className='outline-none bg-transparent p-2 border-2 border-solid border-green-950' type="mail" id="last" name="mail" /></label>
                        <label className='flex flex-col' for="last">Message:
                        <textarea className=' resize-none h-48 p-2 outline-none bg-transparent border-2 border-solid border-green-950' type="mail" id="last" name="mail" /></label>
                        <button className=' bg-transparet border-2 border-solid border-green-950 w-28 p-2' type="submit">SUBMİT</button>
                    </form>
                </div>
            </div>
        </div>
